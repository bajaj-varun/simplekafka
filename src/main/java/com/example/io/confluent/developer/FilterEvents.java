package com.example.io.confluent.developer;
...
public class FilterEvents {
    ...
    public Properties buildStreamsProperties(Properties envProps) {
        ...
        System.out.println(envProps.getProperty("bootstrap.servers"));
    ...
    public Topology buildTopology(Properties envProps,
        ...
        KStream<String, Publication> pb = builder.stream(inputTopic, Consumed.with(Serdes.String(), publicationSerde));

        pb.foreach((name, publication) -> System.out.println(publication.getName()));

//        KStream<String, Publication> pbt = pb.filter((name, publication) -> "George R. R. Martin".equals(publication.getName()));
        System.out.println("Test");
        pb.filter((name, publication) -> (publication.getName() == "George R. R. Martin"))
